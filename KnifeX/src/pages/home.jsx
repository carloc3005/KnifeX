...
function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="text-center mt-16">
                        {isAuthenticated ? (
                            <Link 
                                to="/inventory"
                                className="group inline-flex items-center bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold py-4 px-12 rounded-2xl text-xl shadow-2xl transform hover:scale-110 transition-all duration-300"
                            >
            ...
            <section className="py-24">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="bg-gradient-to-r from-red-600 via-pink-600 to-purple-600 rounded-3xl p-16 text-center relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-2xl md:text-3xl text-gray-100 mb-12 max-w-4xl mx-auto leading-relaxed">
                                New users get <span className="font-bold text-yellow-300 text-4xl">25% BONUS CREDITS</span> on their first deposit. 
                                Start your knife collection with extra buying power!
                            </p>
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                <button className="bg-yellow-400 hover:bg-yellow-300 text-gray-900 font-bold py-5 px-12 rounded-2xl text-xl shadow-2xl transform hover:scale-110 transition-all duration-300">
                                    💰 Claim 25% Bonus Now!
                                </button>
                                <div className="bg-red-500/80 backdrop-blur-sm text-white font-bold py-4 px-8 rounded-2xl text-lg border-2 border-yellow-400 animate-pulse">
                                    ⏰ Ends in 2 days!
                                </div>
                            </div>
                        </div>
            ...
            {isAuthenticated && (
                <section className="py-20 bg-gradient-to-r from-cyan-800/40 to-purple-800/40 backdrop-blur-sm">
                    <div className="max-w-7xl mx-auto px-4 text-center">
                        <h2 className="text-5xl font-extrabold text-white mb-6">
                            Welcome back, <span className="text-cyan-400">{user?.username}</span>! 👋
                        </h2>
                        <p className="text-2xl text-gray-300 mb-12">
                            Ready to expand your knife collection or make some trades?
                        </p>
                        <div className="flex flex-col lg:flex-row gap-6 justify-center">
                            <Link 
                                to="/inventory"
                                className="group bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold py-4 px-12 rounded-2xl text-xl shadow-2xl transform hover:scale-110 transition-all duration-300"
                            >
                                <span className="flex items-center">
                                    📦 Manage Inventory
                                    <svg className="ml-2 w-6 h-6 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Link 
                                to="/knives"
                                className="group bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-400 hover:to-pink-500 text-white font-bold py-4 px-12 rounded-2xl text-xl shadow-2xl transform hover:scale-110 transition-all duration-300"
                            >
                                <span className="flex items-center">
                                    🛒 Browse Market
                                    <svg className="ml-2 w-6 h-6 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section className="py-24 bg-gradient-to-r from-gray-800/50 to-purple-800/50">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-6xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                            🛡️ Trusted & Secure
                        ...
                        <p className="text-2xl text-gray-300 max-w-3xl mx-auto">
                            Your security is our top priority. Trade with confidence on KnifeX.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        <div className="text-center p-8">
                            ...
                            <p className="text-gray-400">Bank-level security</p>
                        </div>
                        <div className="text-center p-8">
                            <div className="text-6xl mb-4">⚡</div>
                            <h3 className="text-xl font-bold text-white mb-2">Instant Trades</h3>
                            <p className="text-gray-400">Lightning fast transfers</p>
                        </div>
                        <div className="text-center p-8">
                            <div className="text-6xl mb-4">🎯</div>
                        ...
                        <div className="text-center p-8">
                            <div className="text-6xl mb-4">💎</div>
                            <h3 className="text-xl font-bold text-white mb-2">Verified Items</h3>
                            <p className="text-gray-400">100% authentic skins</p>
                        </div>
                    </div>
                </div>
            </section>
